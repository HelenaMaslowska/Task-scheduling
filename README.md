...
Sort tasks on a 1 machine, minimize the number of late tasks. Task have time to be done and end time. We 2 another versions of this program, changing speed and number of machines and adding starting point for each task, or making task divisible.
